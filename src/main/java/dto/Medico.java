...
@NamedQueries({
    ...
    @NamedQuery(name = "Medico.findByCodigo2FA", query = "SELECT m FROM Medico m WHERE m.codigo2FA = :codigo2FA")})
public class Medico implements Serializable {
    ...
    public Medico(Integer codiMedi, String codigo2FA) {
        this.codiMedi = codiMedi;
